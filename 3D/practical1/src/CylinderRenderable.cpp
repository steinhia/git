    ...
    m_pBuffer(0), m_cBuffer(0)
{
  ...
  double th_k=0;
  double th_kp1=k;
  glm::vec3 center=glm::vec3(0,0,0.5);
  glm::vec3 center1=glm::vec3(0,0,0.5);
  glm::vec3 v1;
  glm::vec3 v2;
  glm::vec4 n;
     for (unsigned int i=0; i<nb_faces; i++) {
       glm::vec3 pt1=glm::vec3(glm::cos(th_k),sin(th_k),0);
       glm::vec3 pt2=glm::vec3(glm::cos(th_k),sin(th_k),1);
       glm::vec3 pt3=glm::vec3(glm::cos(th_kp1),sin(th_kp1),0);
       glm::vec3 pt4=glm::vec3(glm::cos(th_kp1),sin(th_kp1),1);
    m_positions.push_back(pt1);
    m_positions.push_back(pt2);
    m_positions.push_back(pt4);
    v1=pt2-pt1;
    v2=pt4-pt1;
    n=glm::vec4(v1[1]*v2[2]-v1[2]*v2[1],v1[2]*v2[0]-v1[0]*v2[2],v1[0]*v2[1]-v1[1]*v2[0],0);
...
color = glm::vec4(1,1,0,1);
    ...
    th_kp1+=k;
     ...
     /*    glm::vec3 pt1=glm::vec3(1,1,0);
    glm::vec3 pt2=glm::vec3(1,1,1);
    glm::vec3 pt3=glm::vec3(0,1,1);
    m_positions.push_back(pt1);
    m_positions.push_back(pt2);
    m_positions.push_back(pt3);
    glm::vec4 color = glm::vec4(0,1,0,1);
...
CylinderRenderable::CylinderRenderable(ShaderProgramPtr shaderProgram,glm::vec3 center,glm::vec3 center1, int r) :
    Renderable(shaderProgram),
    m_pBuffer(0), m_cBuffer(0)
{
  int nb_faces=10;
  ...
  double th_kp1=k;
     ...
     for (unsigned int i=0; i<nb_faces; i++) {
       glm::vec3 pt1=glm::vec3(glm::cos(th_k)*r,sin(th_k)*r,center[2]);
       glm::vec3 pt2=glm::vec3(glm::cos(th_k)*r,sin(th_k)*r,center1[2]);
       glm::vec3 pt3=glm::vec3(glm::cos(th_kp1)*r,sin(th_kp1)*r,center[2]);
       glm::vec3 pt4=glm::vec3(glm::cos(th_kp1)*r,sin(th_kp1)*r,center1[2]);
    m_positions.push_back(pt1);
    m_positions.push_back(pt2);
    m_positions.push_back(pt4); 
